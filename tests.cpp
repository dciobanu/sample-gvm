        ...
        static void test_errors() {
            ...
            { 
                ...
                try {
                    ...
                    expected = true;
                    cout << "Alertcmake" << endl;
                } catch(...) {
                    cout << "Well this sucks!" << endl;
                }
                assert(expected);
                assert(vm1->ic == 1000);
                assert(vm1->ip == 1000);
...
int main() {
    ...
    GenesysVMTest::test_errors();
    GenesysVMTest::test_halting();
    GenesysVMTest::test_setR();

    GenesysVMTest::test_sample1();
}